...
In addition to managing Runs, `formr` allows you to directly interact with the underlying Surveys (the spreadsheets containing your items and logic). While the [Project Workflow](manage-your-studies.html) (`formr_push_project`) is recommended for syncing entire studies, the functions below allow you to list, inspect, download, or delete specific surveys individually.

## Listing Your Surveys

To view a list of all surveys associated with your account, use `formr_surveys()`. This returns a tidy data frame containing the survey ID, name, and modification timestamps.
